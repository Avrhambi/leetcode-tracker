...
Read: `AGENTS.md`, `SPEC.md`, `SCHEMA.md`
...
- [x] Wire the catalog attempt form to complete a matching daily recommendation; reword the form copy; surface the unused attempt fields.
